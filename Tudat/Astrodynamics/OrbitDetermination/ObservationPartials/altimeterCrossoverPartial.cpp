...
//    double dR1dt1;
         ...
         positionPartialIterator_++ )
    {
        ...
        if( positionPartialIterator_->first == observation_models::first_arc_body )
        {
            ...
            A_dt2dr1 << bf_r2UniVector.transpose(), bf_v1UnitVector.transpose(), bf_v2UnitVector.transpose();
            Eigen::Vector3d v2InPlane = bf_StateArc2.segment( 3, 3 ) -
                    bf_StateArc2.segment( 3, 3 ).cwiseProduct( bf_r2UniVector );
            ...
            Eigen::Vector3d v1InPlane = bf_StateArc1.segment( 3, 3 ) -
                    bf_StateArc1.segment( 3, 3 ).cwiseProduct( bf_r1UnitVector );
...
//            std::cout << "\n dR2dt2: \n" << dR2dt2 << std::endl;
            ...
            Eigen::Vector3d v2InPlane = bf_StateArc2.segment( 3, 3 ) -
                    bf_StateArc2.segment( 3, 3 ).cwiseProduct( bf_r2UnitVector );
